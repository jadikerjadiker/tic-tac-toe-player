...
static char __pyx_k_export_wrightomega[] = "_export_wrightomega";
...
#endif
{
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_export_wrightomega, (void *)&__pyx_v_5scipy_7special_11_ufuncs_cxx__export_wrightomega, "void *") < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Function export code ---*/
  if (__Pyx_ExportFunction("_set_action", (void (*)(void))__pyx_f_5scipy_7special_11_ufuncs_cxx__set_action, "void (sf_error_t, sf_action_t)") < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
