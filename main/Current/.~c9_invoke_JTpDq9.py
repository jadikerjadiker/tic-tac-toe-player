...
if __name__ == "__main__":
    ...
    #This tests the neural net player against other players
    bigRes = []
    testData = [[], []]
    ...
    for trainSpec in [.6]:
        ...
        while True:
            ...
            for player in players:
                ress.append(test.testAgainstRandom(player, gameClass, **testInfo))
            testData[0].append(ress[-len(players)+playerIndexesToCompare[0]][-1][-1])
            testData[1].append(ress[-len(players)+playerIndexesToCompare[1]][-1][-1])
            print(testData)
